...
offset.storage.replication.factor=${CONFIG_STORAGE_REPLICATION_FACTOR}
...
status.storage.replication.factor=${CONFIG_STORAGE_REPLICATION_FACTOR}
...
# Default: 60000 (ms, 1분)  # 오프셋 커밋 주기
offset.flush.interval.ms=${OFFSET_FLUSH_INTERVAL_MS}
# Default: 5000 (ms, 5초)   # 오프셋 커밋 완료 대기시간. 넘으면 커밋실패로 취급
offset.flush.timeout.ms=${OFFSET_FLUSH_TIMEOUT_MS}
